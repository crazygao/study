...
# check the system resources and bottlenecks
# 1. CPU usage and workload (top, vmstat, sar)
# 2. Disk, Inode, I/O workload (df, iostat, iotop, sar, dstat)
# 3. Memory usage (free, vmstat)
# 4. Check Processes that occupy the most memory (top, ps)
# 5. Check Network Resources (ifconfig, iftop, iptraf)
